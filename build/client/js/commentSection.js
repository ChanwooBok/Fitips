...
var addComment = function addComment(text, commentId) {
  ...
  var newDeleteCommentBtn = document.querySelector("#newCommentBtn");
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _event$target$dataset = event.target.dataset, id = _event$target$dataset.id, videoId = _event$target$dataset.videoId; // videoId까지 찾아주는 이유 : video마다 코멘트가 달려있기 때문에..
            _context.next = 3;
