...
userRouter.get("/github/start", _middlewares.publicOnlyMiddelware, _userController.startGithubLogin);
userRouter.get("/github/finish", _middlewares.publicOnlyMiddelware, _userController.finishGithubLogin);
