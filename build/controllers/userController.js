...
var getEdit = function getEdit(req, res) {
  ...
  return res.render("edit-profile", {
    pageTitle: "Edit ".concat(user.name, "'s Profile")
  });
};
exports.getEdit = getEdit;
var postEdit = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$session$user, avatarUrl, _id, sessionName, _req$body2, name, email, username, location, file, findUsername, findEmail, updatedUser;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _req$session$user = req.session.user, avatarUrl = _req$session$user.avatarUrl, _id = _req$session$user._id, sessionName = _req$session$user.name, _req$body2 = req.body, name = _req$body2.name, email = _req$body2.email, username = _req$body2.username, location = _req$body2.location, file = req.file;
            _context2.next = 3;
          ...
          case 6:
            ...
            return _context2.abrupt("return", res.render("edit-profile", {
              pageTitle: "Edit ".concat(sessionName, "'s Profile"),
...
var postLogin = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var _req$body3, username, password, pageTitle, user, ok;
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 6:
            return _context5.abrupt("return", res.render("users/profile", {
              pageTitle: user.name,
              user: user
            }));
          case 7:
...
var postChangePassword = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var _id, _req$body4, oldPwd, newPwd, newPwdConfirm, user, match;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _id = req.session.user._id, _req$body4 = req.body, oldPwd = _req$body4.oldPwd, newPwd = _req$body4.newPwd, newPwdConfirm = _req$body4.newPwdConfirm;
          ...
          case 5:
            user = _context6.sent;
            _context6.next = 8;
            return _bcrypt["default"].compare(oldPwd, user.password);
          case 8:
