      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            return _context.abrupt("return", res.render("server-error", {
              error: _context.t0
            }));
          case 10:
          case "end":
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            return _context2.abrupt("return", res.render("watch", {
              pageTitle: "Watching: ".concat(video.title),
              video: video
            }));
          case 7:
          case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            keyword = req.query.keyword; // form ( method = GET )
            videos = [];
            if (!keyword) {
              _context5.next = 6;
              break;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _req$body2 = req.body, title = _req$body2.title, description = _req$body2.description, hashtags = _req$body2.hashtags; // 1. 직접 Video.create()하여 한번에 생성 후 db저장까지 하는 방법.
            _context6.prev = 3;
            _context6.next = 6;
    ...
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            _req$body3 = req.body, id = _req$body3.id, videoId = _req$body3.videoId;
            console.log(id);
            console.log(videoId);
            _id = req.session.user._id; // loggedIn user id
            _context10.next = 6;
